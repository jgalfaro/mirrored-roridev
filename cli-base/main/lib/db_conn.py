...
if (os.getenv('RORI_MYSQL_PASSWORD') != None) and (os.getenv('RORI_MYSQL_PASSWORD') !=""):
    DB_PASS = str(os.getenv('RORI_MYSQL_PASSWORD'))
else:
    print "Error: There is no password defined to connect to '",DB_NAME,"' database!"
    os._exit(2)
