...
from WebServiceClient import AsynchronousClient
import urllib
import json
import sys, getopt


class SendSRDEnrichedResponsePlan():
    def __init__(self):
        self.url = "http://10.10.0.16:8195/srd"
        self.service = "sendSRDEnrichedResponsePlan"
    ...
    def sendRequest(self):
        print '*** sendSRDEnrichedResponsePlan Interface ***'
...
def main(argv):
    ...
    try:
        ...
        print 'Usage: '
        print 'SendSRDEnrichedResponsePlan.py -i <inputJSON>'
        sys.exit(2)
    ...
    interface = SendSRDEnrichedResponsePlan()
